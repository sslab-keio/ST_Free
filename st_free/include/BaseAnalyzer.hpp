...
class BaseAnalyzer {
 ...
 protected:
  ...
  void addLocalVariable(BasicBlock *B, Type *T, Value *V, Instruction *I,
                        ParentList P);
  void addPointerLocalVariable(BasicBlock *B, Type *T, Value *V, Instruction *I,
                               ParentList P);
  void collectStructMemberFreeInfo(Instruction *I, struct collectedInfo &info,
                                   ParentList &additionalParents);
  void collectStructFreeInfo(Instruction *I, struct collectedInfo &info);
  void collectOptimizedStructFreeInfo(Instruction *I,
                                      struct collectedInfo &info);
  void collectSimpleFreeInfo(Instruction *I, struct collectedInfo &info);
  void addNestedFree(Value *V, CallInst *CI, BasicBlock *B,
                     struct collectedInfo &I, ParentList &additionalParents);
  /*** Argument Status ***/
  void copyArgStatus(Function &Func, CallInst *CI, BasicBlock &B);
  void copyArgStatusRecursively(Function &Func, CallInst *CI, BasicBlock &B,
                                Value *arg, ArgStatus *ArgStat, int ind,
