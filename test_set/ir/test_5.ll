; ModuleID = 'src/test_5.c'
source_filename = "src/test_5.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.test = type { i32, [10 x i8], i32, i32, i8* }
...
entry:
  ...
  %call = call noalias i8* @malloc(i64 32) #2
  ...
  %str = getelementptr inbounds %struct.test, %struct.test* %1, i32 0, i32 4
  store i8* %call1, i8** %str, align 8
  %2 = load %struct.test*, %struct.test** %t, align 8
  %str2 = getelementptr inbounds %struct.test, %struct.test* %2, i32 0, i32 4
